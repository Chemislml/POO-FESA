...
public class ControladorEjemplo extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource() == this.view.getBtnMensaje()){
           // System.out.println("Mensaje");
            ImageIcon icono = new ImageIcon("exito.png");
            JOptionPane.showMessageDialog(view, "Hola ejemplo","Titulo personalizado", JOptionPane.WARNING_MESSAGE, icono);
        }
        if(e.getSource() == this.view.getBtnEntrada()){
        ...
        if(e.getSource() == this.view.getBtnOpcion()){
