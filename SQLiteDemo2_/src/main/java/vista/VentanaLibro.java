...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(124, 243, 102));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(243, 102, 102));
        ...
        panel3.setBackground(new Color(102, 151, 243));


        // Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(243, 231, 102));
